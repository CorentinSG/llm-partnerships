...
const copy = {
  fr: {
    ...
    paragraphs: [
      ...
      "Le site comprend cinq annuaires distincts de partenariats LL.M : France–États-Unis, Allemagne–États-Unis, Italie–États-Unis, Royaume-Uni–États-Unis et Suisse–États-Unis.",
      ...
      "La section Royaume-Uni–États-Unis présente les partenariats et parcours formalisés entre universités britanniques et law schools américaines, avec une distinction explicite entre LL.M. et échange donnant seulement des crédits transférables.",
      "La section Suisse–États-Unis recense les doubles diplômes et LL.M. conjoints entre établissements suisses et law schools américaines, avec les coûts, places, conditions et limites relatives aux barreaux.",
  ...
  en: {
    ...
    paragraphs: [
      ...
      "The site contains five separate LL.M partnership directories: France–United States, Germany–United States, Italy–United States, United Kingdom–United States, and Switzerland–United States.",
      ...
      "The United Kingdom–United States section presents formalized partnerships and pathways between UK universities and U.S. law schools, clearly distinguishing an LL.M. from an exchange that only provides transferable credits.",
      "The Switzerland–United States section lists dual degrees and joint LL.M. programs between Swiss institutions and U.S. law schools, including costs, seats, conditions, and bar-exam limitations.",
  ...
  es: {
    ...
    paragraphs: [
      ...
      "El sitio contiene cinco directorios distintos de convenios LL.M: Francia–Estados Unidos, Alemania–Estados Unidos, Italia–Estados Unidos, Reino Unido–Estados Unidos y Suiza–Estados Unidos.",
      ...
      "La sección Reino Unido–Estados Unidos presenta convenios e itinerarios formalizados entre universidades británicas y law schools estadounidenses, distinguiendo claramente un LL.M. de un intercambio que solo aporta créditos transferibles.",
      "La sección Suiza–Estados Unidos reúne dobles titulaciones y LL.M. conjuntos entre instituciones suizas y law schools estadounidenses, con costes, plazas, condiciones y límites relativos a los bar exams.",
  ...
  de: {
    ...
    paragraphs: [
      ...
      "Die Website enthält fünf separate LL.M.-Partnerschaftsverzeichnisse: Frankreich–USA, Deutschland–USA, Italien–USA, Vereinigtes Königreich–USA und Schweiz–USA.",
      ...
      "Der Bereich Vereinigtes Königreich–USA zeigt formalisierte Partnerschaften und Studienwege zwischen britischen Universitäten und US-Law-Schools und unterscheidet klar zwischen einem LL.M. und einem Austausch mit lediglich übertragbaren Credits.",
      "Der Bereich Schweiz–USA verzeichnet Doppelabschlüsse und gemeinsame LL.M.-Programme zwischen Schweizer Institutionen und US-Law-Schools einschließlich Kosten, Plätzen, Bedingungen und Grenzen für Anwaltsprüfungen.",
  ...
  it: {
    ...
    paragraphs: [
      ...
      "Il sito contiene cinque directory distinte di partnership LL.M.: Francia–Stati Uniti, Germania–Stati Uniti, Italia–Stati Uniti, Regno Unito–Stati Uniti e Svizzera–Stati Uniti.",
      ...
      "La sezione Regno Unito–Stati Uniti presenta partnership e percorsi formalizzati tra università britanniche e law school statunitensi, distinguendo chiaramente un LL.M. da uno scambio che offre solo crediti trasferibili.",
      "La sezione Svizzera–Stati Uniti raccoglie doppi titoli e LL.M. congiunti tra istituzioni svizzere e law school statunitensi, con costi, posti, condizioni e limiti relativi agli esami di abilitazione.",
