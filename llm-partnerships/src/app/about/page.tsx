...
const copy = {
  fr: {
    ...
    paragraphs: [
      ...
      "Le site comprend quatre annuaires distincts de partenariats LL.M : France–États-Unis, Allemagne–États-Unis, Italie–États-Unis et Royaume-Uni–États-Unis.",
  ...
  en: {
    ...
    paragraphs: [
      ...
      "The site contains four separate LL.M partnership directories: France–United States, Germany–United States, Italy–United States, and United Kingdom–United States.",
  ...
  es: {
    ...
    paragraphs: [
      ...
      "El sitio contiene cuatro directorios distintos de convenios LL.M: Francia–Estados Unidos, Alemania–Estados Unidos, Italia–Estados Unidos y Reino Unido–Estados Unidos.",
  ...
  de: {
    ...
    paragraphs: [
      ...
      "Die Website enthält vier separate LL.M.-Partnerschaftsverzeichnisse: Frankreich–USA, Deutschland–USA, Italien–USA und Vereinigtes Königreich–USA.",
  ...
  it: {
    ...
    paragraphs: [
      ...
      "Il sito contiene quattro directory distinte di partnership LL.M.: Francia–Stati Uniti, Germania–Stati Uniti, Italia–Stati Uniti e Regno Unito–Stati Uniti.",
