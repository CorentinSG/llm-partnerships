...
export function FounderFaq() {
  ...
  return (
    <section className="mt-12 space-y-6" aria-label="FAQ sur le parcours LL.M et New York Bar">
      <div className="space-y-3">
        ...
        <p className="max-w-3xl text-sm leading-7 text-muted-foreground sm:text-base">
          Cette FAQ répond aux questions que l’on me pose le plus souvent sur mon
          parcours, les LL.M. américains, le coût, la sélection et le barreau de
          New York.
        </p>
      </div>

      <div className="grid gap-4 lg:grid-cols-[0.9fr_1.1fr]">
        <Card className="glass-panel rounded-3xl border-white/20">
          <CardHeader>
          ...
          <CardContent className="space-y-3 text-sm leading-7 text-muted-foreground">
            <p>
              ...
              affaires à Nancy, puis M2 Droit des affaires internationales à Paris
              Dauphine avec un Erasmus à Tilburg.
            </p>
            <p>
              J’ai ensuite effectué un LL.M. à Case Western Reserve University
              grâce à un partenariat avec Dauphine, puis passé le barreau de New
              York.
            </p>
            <p>
              Aujourd’hui, je suis avocat à New York — et ce site a été créé pour
              rendre ce parcours plus lisible pour les étudiants en droit français.
            </p>
          </CardContent>
        </Card>
