...
const germanyGeojson = germanyGeojsonRaw as any
const germanyFeature = germanyGeojson.features?.[0]

const mapCopy = {
  fr: {
    title: "Carte (Allemagne)",
    clear: "Effacer",
    zoomIn: "Zoom avant",
    zoomOut: "Zoom arrière",
    resetZoom: "Réinitialiser le zoom",
    reset: "Reset",
    aria: "Carte d'Allemagne avec points des universités",
    selection: "Sélection :",
  ...
  en: {
    ...
    reset: "Reset",
    aria: "Map of Germany with university points",
    selection: "Selection:",
  ...
  es: {
    ...
    reset: "Reset",
    aria: "Mapa de Alemania con puntos universitarios",
    selection: "Selección:",
  ...
  it: {
    title: "Mappa (Germania)",
    clear: "Chiaro",
    zoomIn: "Ingrandisci",
    zoomOut: "Rimpicciolisci",
    resetZoom: "Reimposta lo zoom",
    reset: "Reset",
    aria: "Mappa della Germania con punti universitari",
    selection: "Selezione:",
...
export function GermanyMap({
  ...
  const { svgPath, projectPoint } = React.useMemo(() => {
    ...
    const d = germanyFeature ? pathGen(germanyFeature) : null
        ...
        <div className="relative">
          ...
          >
            ...
            <g transform={`translate(${transform.x} ${transform.y}) scale(${transform.k})`}>
              {svgPath ? (
                <>
                  <path d={svgPath} fill="url(#deFill)" filter="url(#deSoftShadow)" />
