...
const pageCopy = {
  ...
  de: {
    ...
    chipB: "Partner-LL.M.",
    title: "Finden Sie einen US-amerikanischen LL.M. über eine französische Universität.",
    intro:
    ...
    intro2:
      "Studiengebühren sind häufig die Hauptkosten eines US-amerikanischen LL.M.. Auf dieser Website werden Partnerschaften zwischen französischen Universitäten und US-amerikanischen Rechtsschulen verfolgt, die ermäßigte Studiengebühren, Stipendien oder manchmal vollständige Erlasse anbieten.",
    searchCta: "Suchen Sie nach Partnerschaften",
    costCta: "Jahresbudget berechnen",
    faqCta: "FAQ öffnen",
    germanyCta: "Verzeichnis Deutschland–USA entdecken",
