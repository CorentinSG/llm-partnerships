...
export function FiltersPanel({
  ...
  const t = {
    ...
    de: {
      title: "Suchfilter",
      hint: "Verfeinern Sie die Reise nach Reiseziel, Programm, Zulassung und finanziellen Bedingungen.",
      active: "aktiv",
      none: "Keine aktiv",
      destination: "Ziel",
      frenchUniversity: "Französische Universität",
      partnerCountry: "Partnerland",
      continent: "Kontinent",
      ...
      admission: "Zulassung",
      level: "Erforderliches Niveau",
      programLanguage: "Programmsprache",
      languageTest: "Sprachtest",
      cost: "Kosten und Zuverlässigkeit",
      fees: "Gebühren",
      seats: "Anzahl der Plätze",
      reliability: "Zuverlässigkeitsstatus",
      all: "Alle",
      allFeminine: "Alle",
      confirmed: "Bestätigt",
      toConfirm: "Zur Bestätigung",
      incomplete: "Unvollständige Informationen",
      reset: "Zurücksetzen",
      tip: "Tipp: Die globale Suche deckt jedes Feld ab.",
    },
    it: {
      title: "Filtri di ricerca",
      hint: "Affina per destinazione, programma, ammissione e condizioni economiche.",
      active: "attivi",
      none: "Nessuno attivo",
      destination: "Destinazione",
      frenchUniversity: "Università francese",
      partnerCountry: "Paese partner",
      continent: "Continente",
      ...
      programLanguage: "Lingua del programma",
      languageTest: "Test linguistico",
      cost: "Costi e affidabilità",
      fees: "Tasse",
      seats: "Numero di posti",
      reliability: "Stato di affidabilità",
      all: "Tutti",
      allFeminine: "Tutte",
      confirmed: "Confermato",
      toConfirm: "Da confermare",
      incomplete: "Informazioni incomplete",
      reset: "Reimposta",
      tip: "Suggerimento: la ricerca globale copre tutti i campi.",
    },
  }[language]
  const activeCount =
