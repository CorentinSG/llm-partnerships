...
try {
  ...
  assert.equal(await page.locator('main a[href^="/partnership/"]').count(), 7)
  await expectText(page.locator("main"), /7 partenariats/, "French summary exposes seven partnerships")
  ...
  assert.equal(await page.locator('main a[href^="/partnership/"]').count(), 3)
  await zurich.press("Enter")
  ...
  await expectText(page.locator("main"), /Chicago-Kent College of Law/, "Reduced-tuition shortcut returns Chicago-Kent")
  ...
  await expectText(page.locator("main"), /7 convenios/, "Spanish summary is complete")
  await page.getByRole("button", { name: "Deutsch" }).click()
  await page.getByRole("heading", { level: 1, name: /Schweizer Universität/ }).waitFor()
  await expectText(page.locator("main"), /7 Partnerschaften/, "German summary is complete")
  await page.getByRole("button", { name: "Italiano" }).click()
  await page.getByRole("heading", { level: 1, name: /università svizzera/ }).waitFor()
  await expectText(page.locator("main"), /7 partnership/, "Italian summary is complete")
